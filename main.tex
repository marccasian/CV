...
\begin{itemize}
    ...
    \end{rSubsection}
    \begin{rSubsection}{Bitdefender}{February 2018 - present}{Software Engineer}{
        \begin{itemize}
            \item I\textquotesingle m part of the automation department. We find automation solutions and develop several frameworks to be used by other teams.
             \item Mainly I write code in Python 3.0+, but I also use MySQL, Batch and Linux.
            \item Scrum master between June 2018 - Feb 2019
         \end{itemize}
     }
    \end{rSubsection}
